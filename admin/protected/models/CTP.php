...
class CTP extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idCTP, fechaOrden, tipoOrden, formaPago, idCliente, fechaPlazo, codigo, serie, numero, montoVenta, montoPagado, montoCambio, montoDescuento, estado, factura, autorizado, responsable, obs, idCajaMovimientoVenta, idUserOT, idUserVenta, idImprenta, idCTPParent, tipoCTP', 'safe', 'on'=>'search'),
		);
	}
