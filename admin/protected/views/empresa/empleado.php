...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'nombres',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'apellidos',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'ci',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'cargo',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'turno',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'sueldo',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'face',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'sucursal',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'superior',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'fechaIngreso',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($user,'username',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($user,'password',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($user,'estado',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($user,'tipo',array('class'=>'col-xs-2 control-label')); ?>
		<div class="col-xs-3">
