        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
                array(
                    ...
                    'filter'=>CHtml::activeDropDownList($ventas,'idSucursal',CHtml::listData(Sucursal::model()->findAll(),'idSucursal','nombre'),array("class"=>"form-control input-sm","empty"=>"")),
                ),
                array(
                    'header'=>'Cajer@',
                    'value'=>'$data->idUserVenta0["username"]',
                ),
                array(
                    'header'=>'Nº de Venta',
                    'type'=>'raw',
