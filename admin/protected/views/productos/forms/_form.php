...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'codigo',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
    ...
    <div class="form-group">
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'material',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
        ...
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'color',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
    ...
    <div class="form-group">
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'marca',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
        ...
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'industria',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
	...
	<div class="form-group">
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'familia',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
        ...
        <div class="col-sm-6">
            <?php echo $form->labelEx($model,'detalle',array('class'=>'col-sm-4 control-label')); ?>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <div class="col-sm-6">
            <?php echo $form->labelEx($model,'cantXPaquete',array('class'=>'col-sm-4 control-label')); ?>
                <div class="col-sm-8">
