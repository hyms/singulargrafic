...
class DetalleVenta extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, idVenta, idProducto, cantUnidad, cantPaquete, costoTotal', 'required'),
			array('id, idVenta, idProducto, cantUnidad, cantPaquete, costoTotal', 'numerical', 'integerOnly'=>true),
