...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'idMaterial',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'peso',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'idColor',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'dimension',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'procedencia',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'costoSF',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'costoSFUnidad',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'costoCF',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'costoCFUnidad',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'idIndustria',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-3">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'cantidad',array('class'=>'col-md-2 control-label')); ?>
		<div class="col-md-2">
