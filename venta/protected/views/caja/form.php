<div class="form-group" >
	<?php echo CHtml::activeLabelEx($model,'detalle',array('class'=>'control-label col-xs-2')); ?>
	<div class="col-xs-8">
...
<div class="form-group" >
	<?php echo CHtml::activeLabelEx($model,'factura',array('class'=>'control-label col-xs-2')); ?>
	<div class="col-xs-4">
...
<div class="form-group" >
	<?php echo CHtml::activeLabelEx($model,'idTipoMovimiento',array('class'=>'control-label col-xs-2')); ?>
	<div class="col-xs-5">
...
<div class="form-group" >
	<?php echo CHtml::activeLabelEx($model,'Obs',array('class'=>'control-label col-xs-2')); ?>
	<div class="col-xs-8">
